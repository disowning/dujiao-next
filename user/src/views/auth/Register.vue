        ...
        <form class="theme-auth-form" @submit.prevent="handleRegister">
          ...
          <label class="flex items-start gap-3 rounded-xl border theme-surface-soft px-4 py-3 text-sm theme-text-secondary transition-colors">
            ...
            <span class="leading-6">
              ...
              <a :href="PRIVACY_URL" target="_blank" rel="noopener noreferrer" class="font-semibold theme-link">
                {{ t('footer.privacy') }}
              </a>
              {{ t('auth.register.agreementAnd') }}
              <a :href="TERMS_URL" target="_blank" rel="noopener noreferrer" class="font-semibold theme-link">
                {{ t('footer.terms') }}
              </a>
            </span>
          </label>
...
import { PRIVACY_URL, SITE_NAME, TERMS_URL } from '../../constants/site'
...
const brandSiteName = computed(() => {
  ...
  return siteName !== '' ? siteName : SITE_NAME
})
