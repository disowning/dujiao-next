      ...
      <div
        ...
        <div class="flex flex-col items-center gap-2 md:items-end">
          <div class="flex flex-wrap items-center gap-x-4 gap-y-1 justify-center md:justify-end">
            <a :href="PRIVACY_URL" target="_blank" rel="noopener noreferrer" class="hover:text-gray-900 dark:hover:text-gray-400">{{ t('footer.privacy') || 'Privacy Policy' }}</a>
            <a :href="TERMS_URL" target="_blank" rel="noopener noreferrer" class="hover:text-gray-900 dark:hover:text-gray-400">{{ t('footer.terms') || 'Terms of Service' }}</a>
          </div>
...
import { COPYRIGHT_TEXT, PRIVACY_URL, SITE_NAME, SITE_URL, TERMS_URL } from '../constants/site'
...
const brandSiteName = computed(() => {
  ...
  return typeof siteName === 'string' && siteName.trim() ? siteName.trim() : SITE_NAME
})
